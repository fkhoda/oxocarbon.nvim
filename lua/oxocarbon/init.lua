...
vim.api.nvim_set_hl(0, "MiniIconsBlue", {fg = oxocarbon.base09, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "MiniIconsCyan", {fg = oxocarbon.base15, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "MiniIconsGreen", {fg = oxocarbon.base13, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "MiniIconsGrey", {fg = oxocarbon.base04, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "MiniIconsOrange", {fg = oxocarbon.base12, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "MiniIconsYellow", {fg = oxocarbon.base07, bg = oxocarbon.none})
